      ...
      <ThemeProvider>
        <AuthProvider>
          <WishlistProvider>
            <CartProvider>
              <Router>
              <div className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans selection:bg-brand-pink selection:text-white overflow-x-hidden transition-colors duration-300">
                <Navbar />
