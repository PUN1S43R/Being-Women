                ...
                {(product.sizes || []).map((size: string) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-12 h-12 flex items-center justify-center rounded-full border-2 font-bold transition-all relative overflow-hidden ${
                        !available 
                          ...
                          : selectedSize === size 
                            ...
                            : 'border-neutral-100 dark:border-neutral-800 text-neutral-700 dark:text-neutral-300 hover:border-brand-pink hover:bg-brand-pink-light/30'
                      }`}
                    >
                      <span>{size}</span>
                      {!available && (
                ...
                {(product.colors || []).map((color: string) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-6 py-2.5 rounded-full border-2 font-bold text-xs transition-all relative overflow-hidden ${
                        !available 
                          ? 'border-neutral-200 bg-neutral-100/50 text-neutral-400 cursor-not-allowed opacity-50' 
                          : selectedColor === color 
                            ? 'border-brand-pink bg-brand-pink text-white shadow-md' 
